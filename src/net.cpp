...
static const char *strMainNetDNSSeed[][2] = {
    {"kittehcoin.info", "dnsseed.kittehcoin.info"},
    {"kittehcoinwallet.com", "dnsseed.kittehcoinwallet.com"},
    {"kittehcoinblockexplorer.com", "dnsseed.kittehcoinblockexplorer.com"},
    {"kittehcoinpool.com", "dnsseed.kittehcoinpool.com"},
    {NULL, NULL}
};
